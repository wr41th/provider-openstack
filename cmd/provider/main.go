...
import (
	...
	"github.com/home.net/provider-openstack/apis"
	"github.com/home.net/provider-openstack/apis/v1alpha1"
	"github.com/home.net/provider-openstack/config"
	"github.com/home.net/provider-openstack/internal/clients"
	"github.com/home.net/provider-openstack/internal/controller"
	"github.com/home.net/provider-openstack/internal/features"
)

func main() {
	var (
		app                     = kingpin.New(filepath.Base(os.Args[0]), "Terraform based Crossplane provider for Openstack").DefaultEnvars()
	...
	kingpin.FatalIfError(controller.Setup(mgr, o), "Cannot setup Openstack controllers")
